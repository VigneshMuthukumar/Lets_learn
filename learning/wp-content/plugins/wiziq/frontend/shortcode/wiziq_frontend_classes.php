	...
	class Wiziq_Frontend_Classes { 
		...
		<div class="front_wiziq" id="front_wiziq" >
			...
			<div class="wiziq_right" >
				<ul class = "wiziq_front_menu">
					<li><a href="<?php echo $courses_url; ?>" ><?php _e('Courses', 'wiziq'); ?></a></li>
					<?php if ( $wiziq_class_permission ) : ?>
					<li><a href="<?php echo $add_curl; ?>" ><?php _e('Create Class', 'wiziq'); ?></a></li>
					<?php endif; ?>
					<?php if ( $content_permission ) : ?>
					<li><a href="<?php echo $content_url; ?>" ><?php _e('Content', 'wiziq'); ?></a></li>
					<?php endif; ?>
				</ul>
		...
		function wiziq_frontend_view_recurring_classes ( $course_id, $master_id ) {
			...
			<div class="wiziq_right" >
				<ul class = "wiziq_front_menu">
					<li><a href="<?php echo $courses_url; ?>" ><?php _e('Courses', 'wiziq'); ?></a></li>
					<li><a href="<?php echo $classes_url; ?>" ><?php _e('Classes', 'wiziq'); ?></a></li>
					<?php if ( $wiziq_class_permission ) : ?>
						<li><a href="<?php echo $add_curl; ?>" ><?php _e('Create Class', 'wiziq'); ?></a></li>
					<?php endif; ?>
				</ul>
		...
		*/ 
		...
		function wiziq_add_classes_form_front ( $nonce, $course_id ) {
			...
			<div class="wiziq_right" >
				<ul class = "wiziq_front_menu">
					<li><a href="<?php echo $courses_url; ?>" ><?php _e('Courses', 'wiziq'); ?></a></li>
					<li><a href="<?php echo $returnurl; ?>" ><?php _e('Classes', 'wiziq'); ?></a></li>
				</ul>
				<div class = "clearfix" ></div>
