 ...
 jQuery(document).ready(function(){
	...
	jQuery('#wiziq-add-user').click(function () {
		...
		jQuery.map(jQuery('#wiziq-all-user').find("option:selected"),function(option, i) {
			...
			permission_string += '<td><input type="hidden" value="0" name="download_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox" '+ class_checked + ' name="download_recording['+jQuery(option).val()+']" class="download_recording"/> </td>';
